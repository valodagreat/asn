    ...
    <div className="w-full phone:h-full phone:justify-center phone:items-center phone:flex" >
      <div className="text-center" >
          ...
          <div className="w-full flex justify-center pb-20 md:pb-40 xl:pb-88 xl:pt-11 pt-3" >
            <button className='md:text-[16px] w-[198px] xl:w-[440px] md:w-[260px] md:h-[40px] xl:h-[72px] rounded-[200px] md:rounded-[1000px] bg-[#CC2630] h-[48px] text-white flex items-center justify-center xl:text-[24px] xl:leading-[24px] text-[12px] leading-[6px] md:leading-[16px]' >
                Get Involved
          </button>
          </div>
      </div>
