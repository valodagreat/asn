        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-8 md:gap-12 xl:gap-16">
          <div className="flex flex-col gap-4 md:gap-6 xl:gap-8 w-full md:max-w-[55%] text-center md:text-left">
            <div className="space-y-3 md:space-y-4">
              ...
              <p
                className={`text-white/90 text-sm sm:text-base md:text-lg xl:text-xl leading-[1.6] mx-auto md:mx-0 max-w-[95%]`}
              >
                Check out our Youtube channel, learn more about the organisation and bine watch our previous online
                events.
              </p>
            </div>
